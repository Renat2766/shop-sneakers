...
function Drawer({onClose, onRemove, items = []}) {
  ...
  <div  className="overlay">
    <div className="drawer">
      ...
      onClick={onClose} className="removeBtn cu-p" src="/img/btn-remove.svg" alt="Close" /></h2>
    ...
    <div className="cartTotalBlock">
      ...
      <img src="/img/empty-cart.jpg" alt="Empty" className="mb-50" width="120px" height="120px"/>
      <h2>Корзина пустая</h2>
      <p className="opacity-6">Добавьте хоть одну пару кроссовок, чтобы сделать заказ</p>
